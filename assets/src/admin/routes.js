...
const InitLocalStorageSettings = (props) => {
    ...
    return (
        <InitDataBaseSettingsWithHoc
            atrcStore={BlankPluginLocalize.store}//store from AtrcRegisterStore
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const rootElement = document.getElementById(BlankPluginLocalize.root_id);
    ...
    if (rootElement) {
        ...
        render(
            <InitLocalStorageSettingsWithHoc
                atrcStore={BlankPluginLocalize.store} //store from AtrcRegisterStore
                atrcStoreKey='BlankPluginLocal'//key from admin.js
            />,
            rootElement
        );
    }
