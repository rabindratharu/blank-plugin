...
const SettingsRouters = () => {
	return (
		<>
			<AtrcRoutes>
				<AtrcRoute exact path="setting1/*" element={<Settings1 />} />
				<AtrcRoute exact path="setting2/*" element={<Settings2 />} />
				<AtrcRoute exact path="advanced/*" element={<Advanced />} />
				<AtrcRoute
					path="/"
					element={<AtrcNavigate to="setting1" replace />}
				/>
			</AtrcRoutes>
			<SaveSettings />
		</>
			...
			renderSidebar={
				<AtrcNav
					...
					navs={[
						{
							to: 'setting1',
							children: __('Settings 1', 'blank-plugin'),
						},
						{
							to: 'setting2',
							children: __('Settings 2', 'blank-plugin'),
						},
						{
							to: 'advanced',
							children: __('Advanced', 'blank-plugin'),
						},
					]}
				/>
			}
