		...
		<AtrcContent>
			<AtrcPanelRow>
				<AtrcControlText
					...
					placeholder={__('Enter Text', 'blank-plugin')}
					value={setting1}
			...
			<AtrcPanelRow>
				<AtrcControlText
					...
					placeholder={__('Enter Another Text', 'blank-plugin')}
					value={setting2}
			...
			renderContent={
				<>
					<AtrcPanelBody
						...
						title={__('FAQ Query 1?', 'blank-plugin')}
						initialOpen={true}
					>
						<AtrcText
							tag="p"
						...
						>
							{__('FAQ Answer 1', 'blank-plugin')}
						</AtrcText>
					</AtrcPanelBody>
					<AtrcPanelBody
						title={__('FAQ Query 2?', 'blank-plugin')}
						initialOpen={false}
					>
						<AtrcText
							tag="p"
