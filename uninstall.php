...
if ( ! defined( 'BLANK_PLUGIN_DIR' ) ) { // to prevent fatal error when plugin is deleted because BLANK_PLUGIN_DIR is defined in onesearch.php level.
...
function cleanup_algolia_index(): void {
	...
	$indexer = new \BlankPlugin\Modules\Search\Index();
...
function load_dependencies(): bool {
	...
	return class_exists( '\BlankPlugin\Autoloader' ) && \BlankPlugin\Autoloader::autoload();
}
