...
use BlankPlugin\Contracts\Traits\Singleton;
...
class Main {
	 ...
	 *
	 * @var class-string<\BlankPlugin\Contracts\Interfaces\Registrable>[]
	 */
				...
				static function () {
					wp_admin_notice(
						...
						/* translators: 1: Plugin name */
							__( 'Blank Plugin: The plugin requires pretty permalinks to be enabled. Please go to <a href="%s">Permalink Settings</a> and enable an option other than <code>Plain</code>.', 'blank-plugin' ),
