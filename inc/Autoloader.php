...
final class Autoloader {
	...
	public static function autoload(): bool {
		...
		if ( defined( 'BLANK_PLUGIN_AUTOLOAD' ) && false === BLANK_PLUGIN_AUTOLOAD ) {
			return true;
		}
		...
		$autoloader      = BLANK_PLUGIN_DIR . 'vendor/autoload.php';
		...
		foreach ( $hooks as $hook ) {
			add_action(
				...
				static function (): void {
					$error_message = __( 'Blank Plugin: The Composer autoloader was not found. If you installed the plugin from the GitHub source code, make sure to run `composer install`.', 'blank-plugin' );
